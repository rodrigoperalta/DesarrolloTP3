...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("yo", "CastlevaniaR.M.N", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Castlevania R.M.N";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Castlevania R.M.N", null, { width: 768, height: 720 });
