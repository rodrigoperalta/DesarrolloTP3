...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("assets/images/ammo.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/A_RoboCop_logo.png", "assets/images/A_RoboCop_logo.png");
			type.set ("assets/images/A_RoboCop_logo.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/boomerang.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/Canon.png", "assets/images/Canon.png");
			type.set ("assets/images/Canon.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/dron.png", "assets/images/dron.png");
			type.set ("assets/images/dron.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/Espada.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/manogolpe.png", Reflect.field (AssetType, "image".toUpperCase ()));
