...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/images/enemigo.png");
		...
		urls.push ("assets/images/Fondo.psd");
		types.push (lime.Assets.AssetType.BINARY);
		
		
		urls.push ("assets/images/murcielago.png");
		types.push (lime.Assets.AssetType.IMAGE);
		...
		urls.push ("assets/images/Pisodeslisante.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/Robocop.png");
		types.push (lime.Assets.AssetType.IMAGE);
		...
		urls.push ("assets/images/tilesfuego.png");
		types.push (lime.Assets.AssetType.IMAGE);
	...
	public static function main () {
		...
		config = {
			...
			build: "3",
			company: "yo",
			file: "CastlevaniaR.M.N",
			fps: 60,
			name: "Castlevania R.M.N",
			orientation: "",
